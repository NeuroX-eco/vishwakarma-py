...
$(document).ready(function () {
    ...
    eel.expose(showProfileCreation)
    function showProfileCreation() {
        $("#Loader").attr("hidden", true);
        $("#ProfileCreation").attr("hidden", false);
    }
    
    // Hide Profile Creation
    eel.expose(hideProfileCreation)
    function hideProfileCreation() {
        $("#ProfileCreation").attr("hidden", true);
    }
